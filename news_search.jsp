...
<html>
    ...
    <body  id="top" style="background-image: url('img/news.jpg');"> <div class="bgded overlay">
...
//                    ResultSet rsMedia = (ResultSet) request.getAttribute("rsMedia");
                    ...
                    ResultSet rsOther = (ResultSet) request.getAttribute("rsOther");
            ...
            <%
                ...
                for (int i = 0; i < rsMedia.size(); i++) {
                    ...
                    int tweetId = rsMedia.get(i).getId();
            %>
                ...
                <div style="padding: 8px;border-style: solid; border-width: 1px; border-color: rgb(160,160,255);text-align: center">
                    <div style="width: 100%;">
                        ...
                        <div style="float: right;padding: 4px;border-radius: 5px;">
                            <a href="twe.jsp?isComment=true&tweetId=<%=tweetId%>" style="background-color: #737CA1;color: white; padding: 3px;">Add Comment</a>
            ...
            <div style="width: 98%;background-color: white;color: blue;margin-bottom: 5px">
                <div style="padding: 8px;border-style: solid; border-width: 1px; border-color: rgb(160,160,255);text-align: center">
                    <div style="padding-top: 5px">
                        <img src="<%= rsOther.getString("img")%>" style="float: left;padding-right: 4px" alt="hhh" width="60" height="60"/>
                        <%= rsOther.getString("post")%>
                        <div style="clear: both"></div>
                    </div>
                </div>
            </div>
